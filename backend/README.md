...
## Project Structure
    ...
    ├── lingering_butterfl_115646  # Django project configurations
...
1. Clone this repo and `cd lingering_butterfl_115646`
...
2. Clone this repo and `cd lingering_butterfl_115646`
